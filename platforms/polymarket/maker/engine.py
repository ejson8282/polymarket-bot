...
HTTP_PROXIES = None       # read operations: book queries, gamma API, meta 鈥?routed through proxy pool
HTTP_PROXIES_WRITE = None  # write operations: cancel, place order 鈥?always direct (None)
WS_PROXY = None
...
def _choose_proxy(cfg: dict, for_ws: bool, shard_key: str = "") -> str | None:
    ...
    for_ws=True  鈫?WS connections (long-lived)
    for_ws=False 鈫?HTTP read operations (book queries, gamma API)

    Write operations (cancel, place) always use None (direct) 鈥?callers must NOT
    ...
    # Stable per-token hash assignment 鈥?different markets use different proxies
    if shard_key:
...
def _init_proxy_settings(cfg: dict):
    ...
    HTTP_PROXIES       鈫?read operations (book queries, gamma API calls)
    HTTP_PROXIES_WRITE 鈫?write operations (cancel, place order) 鈥?always None/direct
    WS_PROXY           鈫?WebSocket connections
    """
    ...
    WS_PROXY = ws_proxy
    HTTP_PROXIES_WRITE = None  # writes always go direct 鈥?never proxy
...
class PolyLPSMulti:
    ...
    def __init__(self, config_path: str = "config.json") -> None:
        ...
        # 鈹€鈹€ Dual-side (low-price) quoting config 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
        ...
        # independent BUY-side markets 鈥?no SELL orders needed.
        ...
        # {token_id: (anchor_value, timestamp)} 鈥?TTL-based
        ...
        # 鈹€鈹€ Global + per-token order throttle 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
        ...
        # {token_id: (meta_dict, timestamp)} 鈥?TTL prevents stale reward/spread data
        ...
        # ordered insertion list 鈥?used for correct FIFO truncation (set is unordered)
        ...
        # --- P2: 鏃ョ洏/澶滅洏 session mode (redesigned: day=scan markets, night=night_markets) ---
        ...
        if depth_snapshot is not None and snapshot.best_bid > 0 and depth_snapshot.best_bid > 0:
            ...
            if divergence > Decimal("0.03"):
                ...
                log(f"[safety] snapshot_divergence slug={slug} token={token_id[:16]} "
                    ...
                    f"diff={divergence}")
                return None  # force skip 鈥?data mismatch
        return snapshot
    ...
    # ---------------------------------------------------------------
    # P0: Watch / Quarantine 鈥?rapid-change market detection
    # ---------------------------------------------------------------
    ...
    # ---------------------------------------------------------------
    # P1: Fill鍚庨檺浠峰崠鍑?鈥?exit strategy
    # ---------------------------------------------------------------
    ...
    # ---------------------------------------------------------------
    # P2: 鏃ョ洏/澶滅洏 session mode (redesigned)
    # ---------------------------------------------------------------
    ...
    async def _session_switch_cleanup(self) -> None:
        ...
        log(f"[session] === SESSION SWITCH: {prev} 鈫?{current} ===")
    ...
    async def _post_delay(self, label: str) -> None:
        # Unified pace 鈥?no fast path for defense, everything goes through same rhythm
    ...
    async def _acquire_order_throttle(self, token_id: str, label: str) -> None:
        ...
        async with self._global_order_lock:
            ...
            # 鈹€鈹€ Per-token cooldown 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
            ...
            # 鈹€鈹€ Global cooldown 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
    ...
    def _infer_tick_from_book(best_bid: Decimal, best_ask: Decimal) -> Decimal:
        # Common Polymarket price grids are 0.01 (1垄) or 0.001 (0.1垄)
    ...
    async def best_bid_guard_loop(self) -> None:
        ...
        Runs independently of the quote cycle 鈥?covers cooldowns, skips, and gaps.
        ...
        while self._running:
            try:
                ...
                # cancel all orders 鈥?we are blind to market changes.
                if self._last_market_ws_ok_ts > 0:
                    ...
                    if market_ws_age > self._market_ws_down_cancel_sec:
                        ...
                        try:
                            ...
                            log(f"[guard-loop] market-ws down {market_ws_age:.0f}s > {self._market_ws_down_cancel_sec:.0f}s 鈥?cancelled all orders")
    ...
    def _build_price_legs(self, token_id: str, book: TopOfBook, live_spread: Optional[Decimal] = None) -> list[Decimal]:
        ...
        # best_bid itself is NEVER included 鈥?it's a fill-risk boundary
        ...
        # 鈹€鈹€ Fine-tick markets (tick < 0.01): percentage-based distribution 鈹€鈹€
        if tick < Decimal("0.01"):
            return self._build_fine_tick_legs(
                token_id, book, tick, reward_lower, safe_top, reward_zone_width, _slug,
            )

        # 鈹€鈹€ Regular 1-cent markets: original mechanical logic 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
    ...
    def _build_fine_tick_legs(
        ...
        Config knobs (in strategy section):
          fine_tick_max_legs      鈥?max number of legs (default 5)
          fine_tick_retreat_pct   鈥?how far into the reward zone to start,
                                   as a fraction of zone width (default 0.35,
                                   meaning skip the top 35% of the zone)
          fine_tick_zone_use_pct  鈥?what fraction of the remaining zone to
    ...
    # 鈹€鈹€ Dual-side: paired mode helpers for <10c markets 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
    ...
    def _paired_side_ready(
        ...
        Called when paired mode is active 鈥?either YES or NO is below
        ...
        if not yes_is_low and not no_is_low:
            # Neither side is in low-price territory 鈥?paired mode not needed
            return True, ""
        ...
        # 鈹€鈹€ Unified paired budget pre-check 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
    ...
    # 鈹€鈹€ Dual-side: auto-inject paired NO token for low-price markets 鈹€鈹€
    ...
    async def update_and_quote_market(self, token_id: str) -> None:
        ...
        async with lock:
            ...
            # 鈹€鈹€ Dual-side gate: auto-injected NO tokens only quote when
            #    either side of the market is below max_mid (10c).
            #    Case A: YES price <= max_mid  鈫?YES is cheap, NO is auto-injected
            #    Case B: YES price >= 1 - max_mid 鈫?NO is cheap (~1-YES <= max_mid)
            mcfg = self._get_mcfg(token_id)
            if mcfg.get("_dual_side_auto"):
                ...
                if yes_snap is not None:
                    ...
                    #   NO cheap:  yes_top_price >= 1 - max_mid  (i.e. NO 鈮?1-YES <= max_mid)
                    yes_is_low = yes_top_price <= self._dual_side_max_mid
                    no_is_low = yes_top_price >= (Decimal("1") - self._dual_side_max_mid)
                    if not yes_is_low and not no_is_low:
                    ...
                    if time.time() - self.last_quote_ts.get(token_id, 0) > 60:
                        ...
                        log(
                            ...
                            f"depth={depth_val} 鈫?paired mode active"
                        )
                else:
            ...
            # 鈹€鈹€ Paired (both-or-none) gate for <10c markets 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
            ...
            # 鈹€鈹€ End paired gate 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
            ...
            # UNIFIED BUDGET PLANNER 鈥?global capital-aware
            # 鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲
            ...
            # 鈹€鈹€ Step 1: compute real available capital 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
            ...
            # 鈹€鈹€ Step 2: compute this side's budget 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
            raw_event_budget = min(avail * pct, avail * Decimal("0.98")) * size_cap
            event_budget = min(raw_event_budget, real_avail)

            # 鈹€鈹€ Step 3: if paired, enforce combined budget constraint 鈹€
            ...
            if is_paired:
                ...
                if paired_reserved_budget > 0:
                    ...
                    # No pre-reserve yet 鈥?just split real_avail
            ...
            # 鈹€鈹€ Step 4: plan generation with degradation cascade 鈹€鈹€鈹€鈹€鈹€鈹€
            # Try: full legs 鈫?fewer back legs 鈫?shrink sizes 鈫?single fallback 鈫?skip
            plan = []
            ...
            # 4b: fallback 鈥?single top leg at minimum size
            ...
            # 鈹€鈹€ Step 5: comprehensive budget log 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
            ...
            try:
                ...
                # race condition 鈥?it fetches a fresh book milliseconds after placing,
    ...
    async def place_post_only_order(self, token_id: str, price: Decimal, size: Decimal, label: str = "post") -> Any:
        ...
        # 鈹€鈹€ Unified throttle: global + per-token (replaces _post_delay) 鈹€鈹€鈹€
        ...
        # 鈹€鈹€ Final pre-order reward-zone validation 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
        snap = self._market_snapshots.get(token_id)
        ...
        # 鈹€鈹€ End pre-order validation 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
    ...
    async def _trade_poll_watch(self) -> None:
        ...
        while self._running:
            try:
                ...
                # keep memory bounded 鈥?use insertion-ordered list for correct FIFO truncation
                ...
                if avail is not None and prev_balance is not None and prev_balance > 0:
                    ...
                    if drop > BALANCE_DROP_ABS or drop_pct > BALANCE_DROP_PCT:
                        log(
                            ...
                            f"drop={drop} pct={drop_pct:.2%} 鈥?possible undetected fill"
                        )
    ...
    async def summary_loop(self) -> None:
        while self._running:
            ...
            msg = (
                "馃搳 PolyLPS-Multi hourly summary\n"
    ...
    async def _get_token_position(self, token_id: str) -> float:
        ...
        try:
            ...
            return -1.0  # unknown 鈥?don't act on error

    async def unwind_tracking_loop(self) -> None:
        """Periodically check pending unwind SELL orders.
        - If position is 0 鈫?already sold (manually or filled), cancel residual order, remove.
        - If the order is no longer in live orders 鈫?assume filled, remove.
        - If age > unwind_max_age_sec and still open 鈫?Discord alert for manual review.
        """
        while self._running:
            ...
            try:
                ...
                for uw in self._pending_unwinds:
                    ...
                    position = await self._get_token_position(token_id)
                    if position == 0.0:
                        # Position gone 鈥?cancel any residual sell order and clear
                    ...
                    if oid and oid not in live_ids:
                        # Order no longer open 鈥?filled or externally cancelled; consider done
                        log(f"[unwind] completed token={token_id} order_id={oid} age={age:.0f}s")
                        continue

                    if age > self._unwind_max_age_sec:
                        # Timed out 鈥?notify via Discord for manual review, keep order alive
                        hours = age / 3600
                        msg = (
